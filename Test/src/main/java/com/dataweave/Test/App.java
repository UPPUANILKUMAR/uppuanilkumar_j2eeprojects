 ...
 */
 class EncryptLogic2 {
    ...
    public String TestMethod( String clearText) throws InvalidKeyException, NoSuchAlgorithmException,
...
public class App 
{
    ...
    public static void main( String[] args )
    {
        ...
        EncryptLogic2 e= new EncryptLogic2();
        try {
        	String s="";
        s=e.TestMethod("anil");
        System.out.print("s::"+s);
        	...
        	System.out.print("s::"+ex.toString());
